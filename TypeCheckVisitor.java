...
public class TypeCheckVisitor implements ASTVisitor {
	...
	public Object visitExpression_Binary(Expression_Binary expression_Binary,
		...
		if(expression_Binary.op.equals(Kind.OP_EQ) || expression_Binary.op.equals(Kind.OP_NEQ)){
			...
			expression_Binary.type_basic = expression_Binary.e0.type_basic;
			type = expression_Binary.type_basic;
		}
		else if((
...
//			}
	...
	public Object visitIndex(Index index, Object arg) throws Exception {
		...
		System.out.println(index.e0.type_basic);
		System.out.println(index.e1.type_basic);
		if(index.e0.type_basic == Type.INTEGER && index.e1.type_basic == Type.INTEGER){
			System.out.println("Is cartesian"+ index.isCartesian());
	...
	public Object visitExpression_PixelSelector(
		...
		if(expression_PixelSelector.index != null){
			expression_PixelSelector.index.type_basic = (Type) expression_PixelSelector.index.visit(this, null);
		}
		Object type = null;		
...
//		REQUIRE:  ExpressionparamNum .Type == INTEGER
...
//		}
		...
		source_CommandLineParam.type_basic = null;
		if(source_CommandLineParam.paramNum.type_basic == Type.INTEGER){
	...
	public Object visitDeclaration_SourceSink(
		...
		if(st.lookupType(declaration_SourceSink.name) == null){
			...
			if((declaration_SourceSink.source.type_basic == declaration_SourceSink.type_basic)||( declaration_SourceSink.source.type_basic == null)){
...
//	}
	...
	public Object visitStatement_Assign(Statement_Assign statement_Assign,
		...
		System.out.println("Check if null"+ statement_Assign);
...
//		}
//		
		System.out.println("lhstype"+statement_Assign.lhs.type_basic);
		System.out.println("etype"+statement_Assign.e.type_basic);
		if((statement_Assign.lhs.type_basic==statement_Assign.e.type_basic) || (statement_Assign.lhs.type_basic==Type.IMAGE && statement_Assign.e.type_basic==Type.INTEGER )){
